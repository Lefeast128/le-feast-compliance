...
const schema = defineSchema({
  ...
  catalogueProducts: defineTable({
    ...
    active: v.boolean(),
    needsCategoryReview: v.boolean(),
    firstSeenAt: v.number(),
    lastSeenAt: v.number(),
    lastSuccessfulSyncAt: v.number(),
  }).index("by_location", ["locationId"]).index("by_location_plu", ["locationId", "plu"]),
  catalogueSyncStatus: defineTable({
    locationId: v.id("locations"),
    lastSuccessfulSyncAt: v.optional(v.number()),
    lastAttemptedSyncAt: v.number(),
    lastError: v.optional(v.string()),
    productCount: v.optional(v.number()),
    addedCount: v.optional(v.number()),
    renamedCount: v.optional(v.number()),
  ...
  trainingCompletions: defineTable({
    ...
    requirementId: v.id("trainingRequirements"),
    teamMemberId: v.id("teamMembers"),
    documentVersionId: v.optional(v.id("trainingDocumentVersions")),
    completedAt: v.number(),
    completedBy: v.id("users"),
  }).index("by_location", ["locationId"]).index("by_requirement", ["requirementId"]).index("by_member", ["teamMemberId"]),
  additionalRequirements: defineTable({
    locationId: v.id("locations"),
    title: v.string(),
    description: v.optional(v.string()),
  ...
  additionalCompletions: defineTable({
    locationId: v.id("locations"),
    requirementId: v.id("additionalRequirements"),
    completedAt: v.number(),
    ...
    teamMemberId: v.id("teamMembers"),
    completedBy: v.id("users"),
  }).index("by_location", ["locationId"]).index("by_requirement", ["requirementId"]),
